...
Zoo = pd.read_csv("D:/C DRIVE-SSD DATA backup 15-12-2020/Desktop/360DigiTmg Assignment/KNN/Zoo.csv")


Zoo_1 = Zoo.iloc[:, 1:17] # Excluding id column
...
Zoo_n = norm_func(Zoo_1.iloc[:, 1:])
Zoo_n.describe()

X = np.array(Zoo_n.iloc[:,:]) # Predictors # We Can do random partioning as well as sequenctial partioning like in r
